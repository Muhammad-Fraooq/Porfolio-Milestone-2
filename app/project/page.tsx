...
const projects = [
  {
    ...
    description: 'Celebrated Eid by uniting our community with vibrant festivities and joyful experiences.',
  ...
  },
  {
    ...
    description: 'Star Educators 🌟: Transforming learning with personalized content and intuitive design',
    image: '/proj_2.webp',
    slug: 'project-two',
  ...
  },
  {
    ...
    description: 'Dressing.pk: Explore our curated collection of trendy and elegant fashion styles just for you.',
    image: '/proj_3.webp',
    slug: 'project-three',
  ...
  },
  {
    ...
    description: 'Golden Shop: Add to Cart Feature – Simplify shopping with our easy “Add to Cart” option.',
    image: '/proj_4.webp',
    slug: 'project-four',
  ...
  },
  {
    ...
    description: 'Headphone Landing: Get personalized headphone picks with customer segmentation.',
    image: '/proj_5.png',
    slug: 'project-five',
  ...
  },
  {
    ...
    description: 'Interactive Resume Builder: Create personalized resumes using HTML, CSS, and TypeScript.',
    image: '/proj_6.webp',
    slug: 'project-six',
...
export default function Projects() {
  return (
    <div className={styles.container}>
      <h1 style={{marginTop: '2rem'}} className={styles.heading}>My Projects</h1>
